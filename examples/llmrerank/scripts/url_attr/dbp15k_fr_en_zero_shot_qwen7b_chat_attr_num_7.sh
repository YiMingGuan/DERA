...
do
    ...
    do
        echo "Running one shot experiment with parameter Seed: ${seed} TEST_STRATEGY:${test_strategy} ..." > ${LOG_DIR}/dbp15k-fr-en-zero-shot-qwen7b-chat-attr-num-7-seed-${seed}-test_strategy-${test_strategy}.log
        python -u test.py \
                --seed ${seed} \
                ...
                --swap_space 4 >> ${LOG_DIR}/dbp15k-fr-en-zero-shot-qwen7b-chat-attr-num-7-seed-${seed}-test_strategy-${test_strategy}.log 2>&1
