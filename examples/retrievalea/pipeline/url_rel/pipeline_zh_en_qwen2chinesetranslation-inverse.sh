...
MASTER_PORT=29503
CONFIG_PATH=config/url_rel/dbp15k_zh_en_qwen2-chat-chinese-translation-inverse.yaml
LOG_FILE=logs/url_rel/dbp15k_zh_en_qwen2-chat-chinese-translation-inverse.log
GPU_NUM=4
