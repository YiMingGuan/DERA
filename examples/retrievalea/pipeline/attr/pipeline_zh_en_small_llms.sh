...
MASTER_PORT=29501
CONFIG_PATH=config/attr/dbp15k_zh_en_small_llms.yaml
LOG_FILE=logs/attr/dbp15k_zh_en_small_llms.log
GPU_NUM=2
...
echo ">>>>>> Start pipeline for DBP15K (ZH-EN). Small LLMs Qwen1.5 0.5B Chat" > $LOG_FILE
