...
MASTER_PORT=29502
CONFIG_PATH=config/attr/dbp15k_ja_en_rerank_top30.yaml
LOG_FILE=logs/attr/dbp15k_ja_en_rerank_top30.log
GPU_NUM=2
...
echo ">>>>>> Start pipeline for DBP15K (ja-EN). Rerank Top 30" > $LOG_FILE
