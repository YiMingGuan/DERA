...
MASTER_PORT=29503
CONFIG_PATH=config/url_trans_rel/dbp15k_zh_en.yaml
LOG_FILE=logs/url_trans_rel/dbp15k_zh_en_qwen2-chat-chinese-translation-inverse.log
GPU_NUM=2

if [ ! -d "logs/url_trans_rel" ]; then
  mkdir -p logs/url_trans_rel
fi
