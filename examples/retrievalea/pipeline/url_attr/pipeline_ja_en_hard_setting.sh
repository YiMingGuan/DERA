...
MASTER_PORT=29503
CONFIG_PATH=config/url_attr_rel/dbp15k_ja_en_hard_setting.yaml
LOG_FILE=logs/url_attr_rel/dbp15k_ja_en_hard_setting.log
GPU_NUM=2
...
echo ">>>>>> Start pipeline for DBP15K (ja-EN). Hard Setting" > $LOG_FILE
