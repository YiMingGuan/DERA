...
MASTER_PORT=29503
CONFIG_PATH=config/url_attr_rel/dbp15k_zh_en_hard_setting.yaml
LOG_FILE=logs/url_attr_rel/dbp15k_zh_en_hard_setting_qwen2-chat-chinese-translation-inverse.log
GPU_NUM=2
...
# echo ">>>>>> Start pipeline for DBP15K (ZH-EN). Hard Setting" > $LOG_FILE
