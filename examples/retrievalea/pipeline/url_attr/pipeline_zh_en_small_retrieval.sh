...
MASTER_PORT=29503
CONFIG_PATH=config/url_attr_rel/dbp15k_zh_en_small_retrieval.yaml
LOG_FILE=logs/url_attr_rel/dbp15k_zh_en_small_retrieval_qwen2-chat-chinese-translation-inverse.log
GPU_NUM=2
